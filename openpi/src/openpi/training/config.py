...
_CONFIGS = [
    TrainConfig(
        ...
        data=LeRobotXarmDataConfig(
            ...
            repo_id="clara/with_rollouts",  # change this
            ...
            assets=AssetsConfig(
                ...
                assets_dir="/home/csbender/openpi/assets/pi05_xarm_finetune/", # this might not be necessary
                asset_id="clara/with_rollouts",
            ),
        ),
